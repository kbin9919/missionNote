...
DROP SEQUENCE SEQ_TEAM_NOTE_NO;
DROP SEQUENCE SEQ_TEAM_MISSION_NO;
DROP SEQUENCE SEQ_ITEM_NO;
DROP SEQUENCE SEQ_MONTH_NOTE_NO;
DROP SEQUENCE SEQ_DAY_NOTE_NO;
DROP SEQUENCE SEQ_DAY_MISSION_NO;
DROP SEQUENCE SEQ_MISSION_NO;
...
DROP TABLE MONTH_NOTE CASCADE CONSTRAINTS;
...
------------ 시퀀스 생성 ------------
------------------------------------
CREATE SEQUENCE SEQ_TEAM_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_TEAM_NOTE_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_TEAM_MISSION_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_ITEM_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_MONTH_NOTE_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_DAY_NOTE_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_DAY_MISSION_NO NOCACHE NOCYCLE;
CREATE SEQUENCE SEQ_MISSION_NO NOCACHE NOCYCLE;
...
------------------------------------
CREATE TABLE UESRS (
	NICK	            VARCHAR2(30)	CONSTRAINT PK_USERS_NICK PRIMARY KEY 
	...
	, SELF_INTRODUCE	VARCHAR2(50)	DEFAULT NULL
    ...
    , DEL_YN            CHAR(1)         DEFAULT 'N' CONSTRAINT NN_USERS_DEL_YN NOT NULL
);
...
CREATE TABLE TEAM (
	...
	, RANK	                VARCHAR(100)	DEFAULT 'F' CONSTRAINT NN_USERS_RANK NOT NULL
	, INVITATION_YN	        CHAR(1)	        DEFAULT 'N' CONSTRAINT NN_TEAM_INVITATION_YN NOT NULL
	, EXPULSION_YN	        CHAR(1)	        DEFAULT 'N' CONSTRAINT NN_TEAM_EXPULSION_YN NOT NULL
	, TEAM_POINT	        NUMBER	        DEFAULT 0 CONSTRAINT NN_TEAM_POINT NOT NULL
	, PUBLIC_YN	            CHAR(1)	        DEFAULT 'N' CONSTRAINT NN_TEAM_PUBLIC_YN NOT NULL
    , DEL_YN                CHAR(1)         DEFAULT 'N' CONSTRAINT NN_TEAM_DEL_YN NOT NULL
);

CREATE TABLE TEAM_NOTE (
    NO	                NUMBER          CONSTRAINT PK_TEAM_NOTE_NO PRIMARY KEY
	, NICK	            VARCHAR2(30)	CONSTRAINT NN_TEAM_NOTE_NICK NOT NULL CONSTRAINT QK_TEAM_NOTE_NICK UNIQUE
	, TITLE	            VARCHAR2(30)	CONSTRAINT NN_TEAM_NOTE_TITLE NOT NULL
	, MISSION	        VARCHAR2(30)	CONSTRAINT NN_TEAM_NOTE_MISSION NOT NULL
	, MISSION_DETAIL	VARCHAR2(3000)	DEFAULT NULL
...
CREATE TABLE TEAM_MISSION (
	...
	, CATEFORY      VARCHAR2(50)	DEFAULT NULL
	...
	, REWARD	    VARCHAR2(300)	DEFAULT NULL
);

CREATE TABLE MONTH_NOTE (   
    NO                      NUMBER                                  CONSTRAINT PK_MONTH_NOTE_NO PRIMARY KEY
    , TITLE                 VARCHAR(50)                             CONSTRAINT UNIQUE_MONTH_NOTE_TITLE NOT NULL
    , MONTH                 TIMESTAMP           DEFAULT SYSDATE     CONSTRAINT UNIQUE_MONTH_NOTE_MONTH NOT NULL
    , DAY                   TIMESTAMP           DEFAULT SYSDATE     CONSTRAINT UNIQUE_MONTH_NOTE_DAY NOT NULL
    , TRGET_OF_MONTH        DEFAULT NULL        
)

CREATE TABLE DAY_NOTE (
    NO                      NUMBER                                  CONSTRAINT PK_MONTH_NOTE_NO PRIMARY KEY
    , DAY_NO                NUMBER                                  CONSTRAINT NN_MONTH_NOTE_DAY_NO NOT NULL
    , TITLE                 VARCHAR(50)                             CONSTRAINT UNIQUE_MONTH_NOTE_TITLE NOT NULL
    , MONTH                 TIMESTAMP           DEFAULT SYSDATE     CONSTRAINT UNIQUE_MONTH_NOTE_MONTH NOT NULL
)
